...
| 版本号        | 发布日期       | 变更说明                                   | 备注 |
| ------------- | ---------- | ------------------------------------------ | ---------- |
| [1.0.1-RELEASE](https://github.com/AnswerAIL/dingtalk-spring-boot-starter/releases/tag/1.0.1-RELEASE) | 2020-07-23 | 初始化版本<br /> + 支持通知消息体自定义<br />+ 支持异常回调 | [V1.0.X使用文档](https://github.com/AnswerAIL/dingtalk-spring-boot-starter/tree/2.x/docs/V1.0.md) |
...
| [2.0.0-RELEASE](https://github.com/AnswerAIL/dingtalk-spring-boot-starter/releases/tag/2.0.0-RELEASE) | 2020-09-06 | + 支持 XXXDinger.xml xml方式消息配置<br /> + 支持@DingerText&@DingerMarkdown注解方式消息配置 | [V2.0.X使用文档](https://github.com/AnswerAIL/dingtalk-spring-boot-starter/tree/2.x/docs/V2.0.md) |
...
## 快速入门文档
- [V1.0快速入门](https://github.com/AnswerAIL/dingtalk-spring-boot-starter/tree/2.x/docs/Getting%20Started%20V1.0.md)

- [V2.0快速入门](https://github.com/AnswerAIL/dingtalk-spring-boot-starter/tree/2.x/docs/Getting%20Started%20V2.0.md)
