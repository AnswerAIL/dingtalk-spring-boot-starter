...
import com.jaemon.dingerframework.multi.annotations.EnableMultiDinger;
...
import static com.jaemon.dingerframework.entity.enums.ExceptionEnum.GLOBAL_MULTIDINGER_CONFIG_EXCEPTION;
import static com.jaemon.dingerframework.entity.enums.ExceptionEnum.MULTIDINGER_ALGORITHM_EXCEPTION;
import static com.jaemon.dingerframework.multi.MultiDingerConfigContainer.GLOABL_KEY;
...
public class MultiDingerScannerRegistrar implements ImportBeanDefinitionRegistrar, Ordered {
     ...
     * <blockquote>
     *     {<br>
     *         key: dingerClassName | {@link MultiDingerConfigContainer#GLOABL_KEY}(key) + {@link com.jaemon.dingerframework.constant.DkConstant#SPOT_SEPERATOR} + {@link AlgorithmHandler}.simpleName<br>
